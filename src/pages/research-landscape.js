...
import { cz, en } from "../content/research/landscape";
...
export const query = graphql`
  query {
    image1: file(
      relativePath: { regex: "/research/landscape/krajina01.jpg/" }
    ) {
      childImageSharp {
        fluid {
    ...
    image2: file(
      relativePath: { regex: "/research/landscape/krajina02.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image3: file(
      relativePath: { regex: "/research/landscape/krajina03.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image4: file(
      relativePath: { regex: "/research/landscape/krajina04.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image5: file(
      relativePath: { regex: "/research/landscape/krajina05.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image6: file(
      relativePath: { regex: "/research/landscape/krajina05b.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image7: file(
      relativePath: { regex: "/research/landscape/krajina06.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image8: file(
      relativePath: { regex: "/research/landscape/krajina07.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image9: file(
      relativePath: { regex: "/research/landscape/krajina08.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
    ...
    image10: file(
      relativePath: { regex: "/research/landscape/krajina09.jpg/" }
    ) {
      childImageSharp {
        fluid {
          ...GatsbyImageSharpFluid_withWebp
