...
export const actualCz = [
  {
    name: "Keltové, úroda a centralizace",
    id: "GF25-19610L",
    finance: "Grantová agentura ČR, Österreichischer Wissenschaftsfonds FWF",
    period: "10/2025–9/2028",
    mainResearcher:
      "Peter Trebsche (University of Innsbruck, Department of Archaeologies)",
    coResearchers:
      "Lydie Dudová (Akademie věd ČR, Botanický ústav), Petra Goláňová (Masarykova Universita, Filozofická fakulta), Andreas G. Heiss (Austrian Academy of Sciences, Austrian Archaeological Institute)",
    teamMembers:
      "Lydie Dudová, Eva Jamrichová, Helena Svitavská Svobodová, Petra Hájková, Přemysl Bobek, Markéta Fránková, Martin Kadlec, Dušan Lekeš, Jana Jiroušková",
    description:
      "Tento projekt zkoumá vznik velkých nížinných osad ve střední Evropě během 3. století př. n. l. Zatímco tyto osady, které předcházely známějším oppidům, byly tradičně spojovány s rozkvětem obchodu a řemeslné výroby, tento výzkum navrhuje novou hypotézu. Jádrem této hypotézy je myšlenka, že primární příčinou růstu těchto osad, a nikoli pouze jeho výsledkem, mohly být inovace v zemědělství a produkce potravinových přebytků. Vzhledem k tomu, že společnost v pozdní době železné byla převážně agrární, přebytek potravin byl nezbytnou podmínkou pro další specializaci v řemeslech. Projekt je společným úsilím výzkumníků z různých oborů a institucí v České republice, Rakousku, Slovensku a Maďarsku. Kombinací archeologické, archeobotanické a paleoekologické analýzy se tým snaží vnést nové světlo na roli zemědělství a přehodnotit toto období změn.",
  },
  {
    name: "Živá infrastruktura minerálních pramenů – přírodě blízká opatření podporující udržitelné využití lázeňské krajiny regionu západních Čech",
    id: "SQ01010075",
    finance: "Technologická agentura ČR",
    period: "01/2025–12/2027",
    mainResearcher: "Markéta Fránková",
    coResearchers:
      "Jana Kulichová (Univerzita Karlova, Přírodovědecká fakulta)",
    teamMembers:
  ...
  },
  {
    ...
    id: "PPLZ-2025-Šolcová",
    finance: "Akademie věd ČR",
    period: "01/2025–12/2026",
    mainResearcher: "Anna Šolcová",
    coResearchers: "",
    teamMembers: "",
    description:
      "Současné geografické rozšíření rostlin a jejich diverzita je výsledkem dlouhodobé evoluce, kdy se druhy přizpůsobovaly a dále přizpůsobují neustále se měnícím environmentálním podmínkám. Náš nejnovější výzkum v rámci GAČR 23-05132S ukázal, že současné druhové složení vodních a mokřadních rostlin (makrofyt) v jezerech severní Evropy je výrazně ovlivněno chemismem vody, konkrétně konduktivitou a alkalinitou. Tento výzkum rovněž naznačuje, že dalším z důležitých environmentálních faktorů, který ovlivňuje druhové složení makrofyt, je např. teplota. Díky těmto znalostem lze pomocí tzv. přenosových funkcí (transfer function) ze (sub)fosilního záznamu kvantitativně rekonstruovat minulé environmentální podmínky prostředí. Díky nově vytvořené přenosové funkci bude možno z fosilního makrozbytkového záznamu odvodit, jak se měnily v minulosti environmentální podmínky prostředí, např. teplota. Hlavními cíli projektu jsou: (A) Vytvořit přenosovou funkci z makrofyt pro rekonstrukci teploty z makrozbytkového a pylového fosilní záznamu z jezerních sedimentů z různých částí Evropy, (B) Použít tuto nově vytvořenou přenosovou funkci na vybraný fosilní záznam k rekonstrukci změny teploty během holocénu a pozdního glaciálu (tj. za posledních cca 15 tisíc let).",
  },
  {
    name: "Paleoekologická rekonstrukce ekosystémů jako podklad pro plánování ochrany zvláště chráněných území",
    id: "SS07010074",
    finance: "Technologická agentura ČR",
    ...
    description:
      "Poznání dlouhodobé dynamiky ekosystémů je nezbytným podkladem pro prioritizaci managementových opatření v chráněných přírodních územích, formulování cílů obnovy, nebo usměrňování druhového složení lesních společenstev. Cílem projektu je implementace poznatků paleoekologického výzkumu do procesu koncepčního plánování v ochraně přírody.",
  },
  {
    name: "Nové kalibrační a indikační systémy pro rekonstrukci holocenního klimatu kontrolované rekonstrukcí lokálních podmínek.",
    id: "GA23-05132S",
...
export const actualEn = [
  ...
  },
  {
    ...
    id: "PPLZ-2025-Šolcová",
    finance: "Czech Academy of Sciences",
    period: "01/2025–12/2026",
    mainResearcher: "Anna Šolcová",
    coResearchers: "",
    teamMembers: "",
    description:
      "The current geographical distribution of plants and their diversity is the result of long-term evolution, during which species adapted and continue to adapt to constantly changing environmental conditions. Our latest research within the GAČR 23-05132S project has shown that the current species composition of aquatic and wetland plants (macrophytes) in lakes of Northern Europe is significantly influenced by water chemistry, specifically conductivity and alkalinity. This research also suggests that another important environmental factor influencing the species composition of macrophytes is, for example, temperature. Thanks to this knowledge, it's possible to quantitatively reconstruct past environmental conditions from the (sub)fossil record using so-called transfer functions. With the newly created transfer function, it will be possible to reconstruct from the macrofossil record how past environmental conditions, such as temperature, have changed in the past. The main objectives of the project are: (A) To create a macrophyte transfer function for the reconstruction of temperature from the macroremain and pollen fossil record in lake sediments from different parts of Europe. (B) To apply this newly created transfer function to a selected (sub)fossil record to reconstruct temperature change during the Holocene and Late Glacial (i.e., over the last approximately 15 thousand years).",
  },
  {
    name: "New calibration and indicator systems for the reconstruction of Holocene climate controlled for local habitat development.",
    id: "GA23-05132S",
    finance: "Grantová agentura ČR",
    period: "01/2023–12/2025",
    mainResearcher: "Petra Hájková",
...
export const completedCz = [
  {
    name: "Příčiny úpadku a systém účinné obnovy prioritních typů stanovišť subalpínských trávníků (SUTR).",
    id: "SS03010065",
    finance: "Technologická agentura ČR",
  ...
  {
    name: "Biodiverzita, historie disturbancí a půdní paměť: testování holocenní kontinuity druhově bohatých lesostepních ekosystémů.",
    id: " GA20-09895S",
    finance: "Grantová agentura ČR",
  ...
  {
    name: "Skryté aktivity v horských oblastech. Archeologický a paleoekologický výzkum na Šumavě.",
    id: "GA17-17909S",
    finance: "Grantová agentura ČR",
  ...
  {
    name: "Srovnání pylových depozic v tundře centrální Evropy a v subarktických oblastech (POLLDEPO).",
  ...
  {
    name: "Dlouhodobá dynamika lesů ve střední Evropě: od odhadů k realistickému modelu (LONGWOOD).",
    id: (
      <>
  ...
  {
    name: "Rekonstrukce vegetace na základě pylových dat – testování modelu a jeho význam pro studium holocénních změn prostředí.",
    id: "KJB6111305",
...
export const completedEn = [
  {
    name: "Causes of decline and a system of effective restoration of priority habitat types of subalpine grasslands (SUTR).",
    id: "SS03010065",
    finance: "Technology agency of the Czech Republic",
    period: "01/2021–12/2023",
    mainResearcher: "Radim Hédl",
  ...
  {
    name: "Biodiversity, disturbance history and soil memory: testing the Holocene continuity of species rich forest-steppe ecosystems.",
    id: " GA20-09895S",
  ...
  {
    name: "Hidden human prehistoric activities in the mountains. Archaeological and pollen evidence from the Šumava Mountains.",
    id: "GA17-17909S",
    finance: "Czech Science Foundation",
    period: "01/2017–12/2019",
  ...
  {
    name: "Comparison of related pollen depositions of tundra in central-European mountains and in subarctic region (POLLDEPO).",
    id: "FP 72007-2013, INTERACT grant agreement 262693",
    finance: "Interact Transnational Access, European commission",
    period: "05/2014–12/2020",
    mainResearcherF: (
  ...
  {
    name: "Pollen-based land-cover reconstruction - model testing and its implications for Holocene environmental change studies.",
    id: "KJB6111305",
    finance: "Grant Agency of the Czech Academy of Sciences",
    period: "2012–2015",
    mainResearcher:
