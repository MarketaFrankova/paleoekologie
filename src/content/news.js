  ...
  },
  {
    ...
    contentShort: (
      <p>
        ...
        <strong>Dnů elektronové mikroskopie</strong>, které každoročně probíhají
        v Mekce elektronové mikroskopie – Brně.&nbsp;
        <AnchorLink
          to="/news#news3"
    ...
    content: (
      <p>
        Letos jsme se poprvé zapojili do{" "}
        <strong>Dnů elektronové mikroskopie</strong>, které každoročně probíhají
        v Mekce elektronové mikroskopie – Brně. Tento ročník proběhl z důvodu
        pandemie čínského koronaviru převážně online a to na webu:&nbsp;
        ...
        <strong>Výzkum rozsivek s využitím elektronového mikroskopu</strong>,
    ...
    content: (
      <>
        ...
        <p>
          ...
          interpretaci paleoekologických výsledků nové informace. Jejím dalším
          inovativním přístupem je netradiční aplikace pylové analýzy v
          souvislosti s archeologickým a historickým výzkumem, například využití
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Jan Roleček ve spolupráci s dalšími vědci z našeho týmu a kolegy z PřF
          ...
          <strong>jako první je přesněji kvantifikovali</strong>. Výsledky
          jejich studie byly publikovány v předním mezinárodním časopise Journal
          of Biogeography.&nbsp;
